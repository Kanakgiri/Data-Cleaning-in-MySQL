...
The data includes Global Layoff information where the company Name, Location, Country, Stage, Funds Raised, Total-laidoff, Percentage-laidoff and Date.
...
## Approach Used for Data Cleaning
